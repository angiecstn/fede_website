    ...
    render() {
        return (
                <div className="ui yellow inverted menu navbar">
                    ...
                    <div className="item"><Link activeClass="active" className="about" to="about1" offset={-120} spy={true} smooth={true} duration={500} >About</Link></div>
                    <div className="item"><Link activeClass="active" className="servizi" to="servizi1" offset={-120} spy={true} smooth={true} duration={500} >Servizi</Link></div>
